...
export function NewMeasurementDialog({
  ...
  const {
    ...
    defaultValues: {
      ...
      diagonalA: undefined as unknown as number,
      diagonalB: undefined as unknown as number,
      headCircumference: undefined as unknown as number,
      remark: "",
    },
  });
      ...
      <Card className="relative w-[520px] max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col min-h-0 flex-1">
          ...
          <div className="p-6 overflow-y-auto flex-1">
            <h2 className="text-lg font-semibold mb-4">新建测量记录</h2>
